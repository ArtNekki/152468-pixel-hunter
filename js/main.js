...
const crossFadeScreen = ({outElement, inElement, duration}) => {
...
var renderAnswerControls = (index) => {
...
var renderAnswers = ({type: questionType, answers}) => {
...
const calculateTotalGameScore = (answers, lives) => {
...
class ResultTableView extends AbstractView {
